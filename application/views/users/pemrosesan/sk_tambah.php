              ...
              <form class="form-horizontal" action="users/sk" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    ...
                    <select class="form-control cari_penerima" name="penerima[]" id="penerima" multiple required>
                      <option value=""></option>
                      <?php
                ...
                <hr>
                <a href="users/sk" class="btn btn-default">
                  << Kembali</a> <button type="submit" id="submit-all" class="btn btn-primary" style="float:right;">Kirim</button>
              </form>
